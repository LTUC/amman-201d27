...
Write a function called sum() that takes in two numbers as arguments and then returns an array where the
 first element is the sum of those numbers, and the second element is a concatenated string that EXACTLY 
 follows this example and uses the values that were input into the function:

"The sum of 4 and 7 is 11."

Test this function by hand in the console to get it
 working, and when you think it is finished, uncomment the call for the testSum()
...
sumNo = a+b;
return[sumNo,"The sum of "+a +" and "+b +" is "+sumNo+"."
]
}
...
multiNo =a*b;
return[multiNo,"The product of "+ a +" and " +b+ " is " +multiNo+"."];
...
operators + and * in this function. To do addition, use your sum() function, and to
...
Test this function by hand in the console to get it working, 
and when you think it is finished, uncomment the call for
...
IMPORTANT DETAIL: You may not use the arithmetic operator +
 in this function. To do addition, use your sum() function that you've already created. 
 You're going to have to be resourceful to figure out how to do this. However,
  you may continue to use the + operator for string concatenation.

Test this function by hand in the console to get it working, 
and when you think it is finished, uncomment the call for the testSumArray() function and see if the test passes.*/
...
IMPORTANT DETAIL: You may not use the arithmetic operator *
 in this function. To do multiplication, use your multiply() 
 
 function that you've already created. You're going to have to be 
...
Test this function by hand in the console to get it working, and when
 you think it is finished, uncomment the call for the testMultiplyAnyArray()
...
let testDynamicArray = [1,2,3,4,5]; //eslint-disable-line
  ...
  function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    var total = dynamicArray[0];
    
    for( var i = 1 ; i < dynamicArray.length ; i++ ) {
      total = multiply(total, dynamicArray[i])[0];
    }
    
    var string = 'The numbers ' + dynamicArray + ' have a product of ' + total + '.';
    return [total,string];
}
